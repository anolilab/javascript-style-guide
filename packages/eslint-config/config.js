import { hasAnyDep, hasTypescript } from './lib/utils.js';
import isModuleAvailable from './lib/is-module-available.js';

// Base rules
export const rules = ['best-practices', 'errors', 'style', 'es6', 'variables'];
...
export const pluginRules = pRules
export const extraInstallPackage = extraInstalled
