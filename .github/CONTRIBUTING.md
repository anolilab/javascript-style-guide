...
Thank you for being a part of the community and helping make these projects great.
...
Please read [the full text](https://github.com/anolilab/javascript-style-guide/blob/main/.github/CODE_OF_CONDUCT.md) so that you can understand what actions will and will not be tolerated.
...
-   If not, open a GitHub Discussion at [Q&A](https://github.com/anolilab/javascript-style-guide/discussions/categories/q-a)
...
-   If nobody submitted this error or bug, open an issue as [Bug report](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fanolilab%2Fjavascript-style-guide%2Fissues%2Fnew%3Fassignees%3D%26labels%3Ds%253A%2Bpending%2Btriage%252Cc%253A%2Bbug%26projects%3D%26template%3Dbug_report.yml) and follow the steps to create the report.
...
-   A team member will try to reproduce the issue with your provided steps.
    If there are no repro steps or no   reproduce the issue, the team will ask you for those steps and mark the issue as `s: awaiting more info`.
...
-   If nobody submitted this request, open an issue as [New feature proposal](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fanolilab%2Fjavascript-style-guide%2Fissues%2Fnew%3Fassignees%3D%26labels%3Ds%253A%2Bpending%2Btriage%252Cc%253A%2Bfeature%252Cs%253A%2Bwaiting%2Bfor%2Buser%2Binterest%26projects%3D%26template%3Dfeature_request.yml) and follow the steps to create the proposal.
...
To help you get your feet wet and get you familiar with our contribution process, we have a list of [good first issues](https://github.com/anolilab/javascript-style-guide/issues?q=is:open+is:issue+label:%22good+first+issue%22) that contain bugs that have a relatively limited scope.
...
So you want to contribute  code! That’s great! This project uses GitHub Pull Requests to manage contributions, so [read up on how to fork a GitHub project and file a PR](https://docs.github.com/en/get-started/exploring-projects-on-github/contributing-to-a-project) if you’ve never done it before.

If this seems like a lot, or you aren’t able to do all this setup, you  also be able to [edit the files directly](https://docs.github.com/en/repositories/working-with-files/managing-files/editing-files) without having to do any of this setup. Yes, [even code](#contribute-code).
...
-   [Fork the project](https://docs.github.com/en/get-started/exploring-projects-on-github/contributing-to-a-project#fork)
...
> If you run into any issue with the setup, check first the [TROUBLESHOOT.md](https://github.com/anolilab/javascript-style-guide/blob/main/.github/TROUBLESHOOT.md)
...
-   If the maintainer decides to pass on your PR, they will thank you for the contribution and explain why they won’t be accepting the changes. That’s ok! We still  appreciate you taking the time to do it, and we don’t take that lightly. 💚
...
Code contributions of  about any size are acceptable!
...
-   Include any [additional documentation](#contribute-documentation) the changes  need.
...
If you ever find yourself deprecating something in the source code, you can follow these steps to save yourself (and the reviewers)  trouble.
...
Not every change needs to be in the migration guide. If it's too long, it becomes hard for users to spot the important changes.
...
JSDoc will be read and automatically processed by `generate:api-docs` and therefore need to follow  project conventions. Other standards are in place because we think they increase the code quality.
...
Helping out other users with their questions is a  awesome way of contributing to any community.
...
Sometimes, a `Q&A` discussion turns out to  be other things, like bugs or feature requests.
...
-   Go to the GitHub discussions and [open the Q&A category](https://github.com/anolilab/javascript-style-guide/discussions/categories/q-a).
...
-   Once the discussion wraps up and things are clarified, either close the issue, or ask the original issue filer (or a maintainer) to close it for you.
 ...
 notes on picking up support discussion:
...
-   Be kind and patient with users -- often, folks who have run into confusing things  be upset or impatient.
    This is ok.
    Try to understand where they’re coming from, and if you’re too uncomfortable with the tone, feel free to stay away or withdraw from the issue. (note: if the user is outright hostile or is violating the CoC, [refer to the Code of Conduct](https://github.com/anolilab/javascript-style-guide/blob/main/.github/CODE_OF_CONDUCT.md) to resolve the conflict).
...
To label issues, [open up the list of unlabeled issues](https://github.com/anolilab/javascript-style-guide/issues?q=is%3Aopen+is%3Aissue+no%3Alabel) and, **from newest to oldest**, read through each one and apply issue labels according to the table below. If you’re unsure about what label to apply, skip the issue and try the next one: don’t feel obligated to label each and every issue yourself!
...
Issues and PRs can go stale after a while. Maybe they’re abandoned. Maybe the team will  plain not have time to address them any time soon.
...
-   Go through each issue _from oldest to newest_, and close them if **All the following are true:**
    ...
    -   Not marked as `good first issue` or `help wanted` (these  stick around for a while, in general, as they’re intended to be available)
    -   No explicit messages in the comments asking for it to be left open
    -   Does not belong to a milestone
-   Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping  if and when you’re ready to resume this. See https://github.com/<**ORGANIZATIONS**>/<**REPOSITORY_NAME**>/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
...
PR reviews use [GitHub’s own review feature](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/reviewing-changes-in-pull-requests/about-pull-request-reviews), which manages comments, approval, and review iteration.

 notes:

-   You may ask for minor changes ("nitpicks"), but consider whether they are  blockers to merging: try to err on the side of "approve, with comments".
...
-   Be extra kind: people who submit code/doc contributions are putting themselves in a  vulnerable position, and have put time, and care into what they’ve done (even if that’s not  to you!) -- always respond with respect, be understanding, but don’t feel like you need to sacrifice your standards for their sake, either.  don’t be a jerk about it?
...
Before merging any PR, define what is the best  do it for the project: should you merge or rebase the approved PR into the `main` branch.
...
TBD—need to hash out a bit more of this process. The most important bit here is  that all tests must pass, and tags must use [semver](https://semver.org).
