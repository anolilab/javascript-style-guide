...
>("all", async (config, oFiles) => {
    ...
    if (tsconfigPath !== undefined) {
        ...
        hasRewriteExtensions = tsConfig.compilerOptions?.rewriteRelativeImportExtensions === true;
    }
    ...
    const rules: TypedFlatConfigItem[] = [
        ...
        },
        {
            ...
            rules: {
                ...
                "import/no-commonjs":
                    packageJson.type === "module"
                        ? ["error", { allowPrimitiveModules: true }]
                        : "off",
    ...
    if (hasPackageJsonAnyDependency(packageJson, ["typescript"])) {
        rules.push({
            ...
            settings: {
                ...
                "import/extensions": [
                    ...getFilesGlobs("js_and_ts"),
                    ...getFilesGlobs("jsx_and_tsx"),
                ...
                "import/parsers": {
                    "@typescript-eslint/parser": getFilesGlobs("ts").map(
