            ...
            if (entry.isDirectory()) {
                ...
                if (existsSync(packageJsonPath)) {
                    try {
                        ...
                        if (packageJson.name) {
                            // Handle both scoped (@anolilab/package-name) and unscoped (package-name) packages
                            const packageName = packageJson.name.startsWith("@anolilab/")
                                ? packageJson.name.replace("@anolilab/", "")
                                : packageJson.name;
                            packages.push({
